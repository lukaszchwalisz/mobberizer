...
export default function Q17() {
  return (
      ...
      <View style={styles.tabs_header}> 
        <Text style={styles.tabs_title}>Na jakich zasadach opiera się postępowanie pojednawcze ?{"\n"}</Text>
        <Text style={styles.tabs_text}>Zasady na jakich opiera się postępowanie pojednawcze opisane są w dziale XII
         kodeksu pracy pt. "Rozpatrywanie sporów o roszczenia ze stosunku pracy". Poniżej zamieszczony zostały tekst rozdziału.{"\n"}
        </Text>
        ...
        Art. 244. {"\n"}
        §1. W celu polubownego załatwiania sporów o roszczeniapracowników ze stosunku pracy
        ...
        § 3. Komisję pojednawczą powołują wspólnie pracodawca i zakładowa organizacja związkowa,
         a jeżeli u danego pracodawcy nie działa zakładowa organizacja związkowa pracodawca,
        ...
        społeczną. Jednakże członek komisjipojednawczej zachowuje prawo do
