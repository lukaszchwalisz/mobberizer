...
export default function K3({ navigation})  {
      return (
            ...
            Z tego miejsca można zarekomendować powołanie komisji pojednawczej w ramach uregulowanego prawnie postępowania pojednawczego (art 244. KP).
            ...
            podchodzi do zgłoszenia podejrzenia wystąpienia zachowań mobbingowych i szybko reaguje uruchamiając zakładowe procedury antymobbingowe.
            ...
            według jakiej procedury działać. Pracodawca ma możliwość przeanalizować cały proces wystąpienia nieprawidłowości i dokonać wielu zmian w firmie, 
            które będą w sensowny sposób przeciwdziałały zachowaniom mobbingowym w pracy.{"\n"}{"\n"}
            ...
            wyjaśnienia sprawy. W efekcie prowadzi to do dalszej eskalacji zachowań mobbingowych, próbach zastraszenia zgłaszających, izolacji
            w grupie pracowników itd. Sytuacja staje się trudna, szczególnie na poziomie emocjonalnym i zdrowotnym. U osoby poddanej
            zachowaniom mobbingowym często pogłębiają się zaburzenia psychosomatyczne, które nie pozwalają pracować i z czasem stają się zagrożeniem dla zdrowia. {"\n"}{"\n"}
